...
// import PageHeaeder from '../../../app/components/common/PageHeaeder';
import { branchPropsType } from '../types/Branch';
import PageHeaeder from '../../../common/components/common/PageHeaeder';
import BranchTbl from '../components/BranchTbl';
import BranchMdl from '../components/BranchMdl';
import UploadMdl from '../components/UploadMdl';

// const BranchMdl = lazy(() => import("../../../app/content/modal/administrator/branch/BranchMdl").then(({ default: BranchMdl }) => ({ default: BranchMdl })));
// const UploadMdl = lazy(() => import("../../../app/content/modal/administrator/branch/UploadMdl").then(({ default: UploadMdl }) => ({ default: UploadMdl })));
// const BranchTbl = lazy(() => import("../../../app/content/table/administrator/BranchTbl").then(({ default: BranchTbl }) => ({ default: BranchTbl })));
