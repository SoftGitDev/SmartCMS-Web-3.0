...
import { Col, Row, Card, Nav, Badge, CardHeader, Button, FormCheck } from 'react-bootstrap';
import { useNavigate, useParams } from 'react-router-dom';
import { LucideTicket, LucideCalendar, Info, TicketSlashIcon, Calendar, Phone, Network, User, FileText, Pencil, Eye, ShieldAlert, Tag, Settings, GitBranch, Layers, Users, MessageCircleDashedIcon, Send, Paperclip, X, CornerUpLeft, XCircle } from 'lucide-react';
