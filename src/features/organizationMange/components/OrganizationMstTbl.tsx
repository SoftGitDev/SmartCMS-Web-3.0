...
interface OrganizationMstTblProps {
    data: any[],
    isLoader: boolean,
...
const OrganizationMstTbl: React.FC<OrganizationMstTblProps> = ({ data, isLoader, setPageSize, setPageNo, totalRecord, setSearchContain, handleBankMdl, loginWithClient }) => {
    return (
        <>
            <Datatable
                data={data}
...
export default OrganizationMstTbl