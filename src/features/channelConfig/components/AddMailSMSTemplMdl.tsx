...
import {  Copy, KeySquare, Loader, LoaderCircle, Mail, MessageSquare, Shield } from 'lucide-react';
...
const AddMailSMSTemplMdl: React.FC<AddMailSMSTemplateProps> = ({ show, handleClose, editedData, getMailSmsTemplateList }) => {
...
export default AddMailSMSTemplMdl