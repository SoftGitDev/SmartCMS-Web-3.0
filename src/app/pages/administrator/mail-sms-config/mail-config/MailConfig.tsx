...
const SMTPConfiguration = lazy(() => import("./SMTPConfiguration").then(({ default: SMTPConfiguration }) => ({ default: SMTPConfiguration })));
const MailAPIConfig = lazy(() => import("./MailAPIConfig").then(({ default: MailAPIConfig }) => ({ default: MailAPIConfig })));
