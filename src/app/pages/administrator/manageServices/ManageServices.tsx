...
import ServicesCards from '../../../content/card/ServicesCards';
import toastNotify from '../../../utils/tostNotify';
import { apiRequest } from '../../../utils/apiRequest';
import * as urls from '../../../utils/url'
import ServiceCreateMdl from '../../../content/modal/manageServices/ServiceCreateMdl';

// Lazy loading the PageHeader component
const PageHeader = lazy(() => import('../../../components/common/PageHeaeder').then(({ default: PageHeader }) => ({ default: PageHeader })));
